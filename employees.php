    ...
    <section class="ftco-section bg-primary">
      <div id="download">
        <table>
            <tr>
            <th colspan="2">
                <input type="button" data-modal="modalOne" value="Add Employee" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">
              </th>
              <!-- ------------------------- -->
                  ...
                  <div class="modal-content">
                    ...
                    <center>
                      <form action="add.php" style="color:black;" method="post">
                        ...
                        <br>
                        <input type="submit" name="submit" class="btn btn-info btn-lg" value="Add">
              ...
              <th colspan="3">
                  ...
                  <center>
                    <a href="search.php" style="color:blue;">click here search based on choice</a>
                  <center>
               </th>
               <th colspan="2">
                <input type="button" value="Download details" class="btn btn-info btn-lg" 
                    onclick="printDiv()">
              </th>
            </tr>
            <tr>
